...
namespace VPortal.TenantManagement.Module.EntityFrameworkCore
{
  ...
  public class TenantManagementDbSchemaMigrator : Common.Module.Migrations.IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public TenantManagementDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(TenantManagementDbContext);

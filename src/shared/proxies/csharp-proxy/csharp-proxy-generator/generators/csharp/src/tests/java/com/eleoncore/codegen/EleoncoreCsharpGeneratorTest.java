 ...
 * 1) Set a break point in EleoncoreCsharpGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class EleoncoreCsharpGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("eleoncore-csharp") // use this codegen library
              ...
              .setOutputDir("out/eleoncore-csharp"); // output directory

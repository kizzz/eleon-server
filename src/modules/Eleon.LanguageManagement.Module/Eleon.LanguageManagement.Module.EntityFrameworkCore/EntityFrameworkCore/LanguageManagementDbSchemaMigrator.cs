...
namespace VPortal.LanguageManagement.Module.Module.EntityFrameworkCore
{
  ...
  public class LanguageManagementDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public LanguageManagementDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(LanguageManagementDbContext);

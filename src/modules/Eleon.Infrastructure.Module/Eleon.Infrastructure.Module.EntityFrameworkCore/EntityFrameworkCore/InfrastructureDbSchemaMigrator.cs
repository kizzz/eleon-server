...
namespace VPortal.Infrastructure.Module.EntityFrameworkCore
{
  ...
  public class InfrastructureDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public InfrastructureDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(InfrastructureDbContext);

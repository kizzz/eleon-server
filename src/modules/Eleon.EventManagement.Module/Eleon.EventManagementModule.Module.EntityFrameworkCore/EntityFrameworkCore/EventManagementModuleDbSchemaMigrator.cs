...
namespace VPortal.EventManagementModule.Module.EntityFrameworkCore
{
  ...
  public class EventManagementModuleDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public EventManagementModuleDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(EventManagementModuleDbContext);

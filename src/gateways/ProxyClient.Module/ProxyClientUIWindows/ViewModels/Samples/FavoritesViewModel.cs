...
using VPortal.ProxyClient.UI.Windows.Services.Samples;
using Location = VPortal.ProxyClient.UI.Windows.Services.Samples.Location;

namespace VPortal.ProxyClient.UI.Windows.ViewModels.Samples;

...
public class SmsNotificationJobParams
{
...
public class SmsNotificationJob : DefaultBackgroundJob, ITransientDependency
{
  private readonly IDistributedEventBus _eventBus;
  private readonly IJsonSerializer _jsonSerializer;

  public SmsNotificationJob(
  ...
  protected override string Type => "SendSmsNotification";

  protected override async Task<JobResult> ProcessExecutionAsync(BackgroundJobEto job, BackgroundJobExecutionEto execution)
  {
    var jobParams = _jsonSerializer.Deserialize<SmsNotificationJobParams>(execution.StartExecutionParams);
    ...
    var result = new JobResult(true, "SMS notifications successfully sent", new List<BackgroundJobTextInfoEto>());

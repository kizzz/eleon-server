...
public class VfsListArgs : VfsBaseArgs
{
  public bool IsRecursiveSearch { get; set; }
  public VfsListArgs(string containerName, string prefix, bool isRecursiveSearch = false, CancellationToken cancellationToken = default) 

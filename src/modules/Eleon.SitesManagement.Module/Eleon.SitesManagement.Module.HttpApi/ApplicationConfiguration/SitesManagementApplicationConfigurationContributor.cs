...
//using VPortal.SitesManagement.Module.TenantAppearance;

namespace VPortal.SitesManagement.Module.ApplicationConfiguration
{
  internal class SitesManagementApplicationConfigurationContributor : IApplicationConfigurationContributor
  {

...
namespace VPortal.DocMessageLog.Module.EntityFrameworkCore
{
  ...
  public class SystemLogDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public SystemLogDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(SystemLogDbContext);

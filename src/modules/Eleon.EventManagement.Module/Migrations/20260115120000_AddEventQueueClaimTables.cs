    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            VisibleAfterUtc = table.Column<DateTime>(type: "datetime2(3)", nullable: true),
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            ContentType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false, defaultValue: "application/json"),
      ...
      migrationBuilder.CreateIndex(
          ...
          .Annotation("SqlServer:Include", new[] { "Id", "Name", "TenantId", "CreatedUtc", "Attempts", "VisibleAfterUtc", "LockedUntilUtc", "MessageKey", "TraceId" });
      ...
      migrationBuilder.CreateIndex(
          name: "UX_EcEventQueueMessages_QueueId_Lane_MessageKey",
          table: "EcEventQueueMessages",

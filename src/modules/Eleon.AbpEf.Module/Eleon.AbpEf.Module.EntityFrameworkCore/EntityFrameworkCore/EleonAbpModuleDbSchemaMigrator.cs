...
namespace VPortal.EventManagementModule.Module.EntityFrameworkCore
{
  ...
  public class EleonAbpModuleDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public EleonAbpModuleDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(EleonAbpDbContext);

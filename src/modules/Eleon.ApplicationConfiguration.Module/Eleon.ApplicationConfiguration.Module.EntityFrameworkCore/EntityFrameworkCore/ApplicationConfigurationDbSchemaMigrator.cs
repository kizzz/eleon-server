...
namespace VPortal.ApplicationConfiguration.Module.Module.EntityFrameworkCore
{
  ...
  public class ApplicationConfigurationDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public ApplicationConfigurationDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(ApplicationConfigurationDbContext);

...
using Eleon.McpSshGateway;
using Eleon.McpSshGateway.Application.Dtos;
using Eleon.McpSshGateway.Application.Services;
using Eleon.McpSshGateway.Infrastructure.Audit;
using Eleon.McpSshGateway.Infrastructure.HostCatalog;
...
namespace Eleon.McpSshGateway.Integration.Tests;
...
public sealed class DockerSshAgentTests
{
    ...
    public async Task Executes_Command_Via_SshAgent_Against_Docker_Target()
    {
        ...
        try
        {
            ...
            var appService = provider.GetRequiredService<SshCommandAppService>();
    ...
    private static ServiceProvider BuildServiceProvider(string catalogPath, string auditPath)
    {
        ...
        services.AddMcpSshGatewayModule();

...
using VPortal.GatewayClient.UI.Windows.Models;
...
namespace VPortal.GatewayClient.ViewModels.ViewModels.Main
{
    public class HostViewModel : ViewModel
    {
        ...
        private readonly WindowsGatewayClientHostServiceService hostServiceService;

        public HostViewModel(
            WindowsGatewayClientHostProcessService hostProcessService,
            WindowsGatewayClientHostServiceService serviceService,

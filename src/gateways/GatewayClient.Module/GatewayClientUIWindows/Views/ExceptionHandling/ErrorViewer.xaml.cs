...
namespace VPortal.GatewayClient.UI.Windows.Views.ExceptionHandling;
...
public partial class ErrorViewer : HorizontalStackLayout
{
    ...
    {
        InitializeComponent();
        this.directoryService = (Microsoft.Maui.Controls.Application.Current as App).Services.GetService<WindowsGatewayClientDirectoryService>();
    }

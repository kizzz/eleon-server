...
using VPortal.GatewayClient.UI.Windows.Services.Samples;
using Location = VPortal.GatewayClient.UI.Windows.Services.Samples.Location;

namespace VPortal.GatewayClient.UI.Windows.ViewModels.Samples;

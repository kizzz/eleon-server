...
using VPortal.GatewayClient.HttpApi.Host.AdminSafelist;
...
[DependsOn(
    ...
    typeof(NatsEventBusModule)
    )]
public class GatewayClientHttpApiHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddHostedService<GatewayHostedService>();
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "VPortal Gateway API");

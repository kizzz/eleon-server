...
namespace VPortal.ExternalLink.Module.EntityFrameworkCore
{
  ...
  public class ExternalLinkDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public ExternalLinkDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(ExternalLinkDbContext);

...
namespace VPortal.SystemServicesModule.Module.EntityFrameworkCore
{
  ...
  public class SystemServicesModuleDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public SystemServicesModuleDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(SystemServicesModuleDbContext);

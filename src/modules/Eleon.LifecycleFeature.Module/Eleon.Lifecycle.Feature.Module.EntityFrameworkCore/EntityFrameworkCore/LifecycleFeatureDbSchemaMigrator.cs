...
namespace VPortal.Lifecycle.Feature.Module.EntityFrameworkCore
{
  ...
  public class LifecycleFeatureDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public LifecycleFeatureDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(LifecycleFeatureDbContext);

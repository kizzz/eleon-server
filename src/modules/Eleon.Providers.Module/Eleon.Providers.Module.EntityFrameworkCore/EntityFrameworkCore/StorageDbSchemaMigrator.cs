...
namespace VPortal.Storage.Module.EntityFrameworkCore
{
  ...
  public class StorageDbSchemaMigrator : IVPortalDbSchemaMigrator, ITransientDependency
  {
    private readonly IServiceProvider _serviceProvider;

    public StorageDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    public async Task MigrateAsync()
    {
      ...
      var dbContextType = typeof(StorageDbContext);

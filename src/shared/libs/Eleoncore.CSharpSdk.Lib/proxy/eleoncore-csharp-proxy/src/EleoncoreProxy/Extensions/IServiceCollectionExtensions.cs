...
namespace EleoncoreProxy.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void ApplyOptions(IServiceCollection services, ApiClientOptions options)
        {
            ...
            ApiConfigurator.Initialize("EleoncoreProxy", new ApiConfigurator(sdkConfig, NullLoggerFactory.Instance, jsonOptions));
            services.AddEleoncoreProxyApi();
        ...
        private static void RegisterHttpClients(IServiceCollection services, ApiClientOptions options, Uri? baseAddress)
        {
            ...
            var builder = services.AddHttpClient("EleoncoreProxy", client =>
            {
                if (baseAddress != null)
                {

...
````bash
Add-Migration Your_Migration_Name -Context VPortalDbContext
````

Using EF Core command line tool;

````bash
dotnet ef migrations add Your_Migration_Name --context VPortalDbContext
````
...
````bash
Add-Migration Your_Migration_Name -Context VPortalTenantDbContext -OutputDir TenantMigrations
````

Using EF Core command line tool:

````bash
dotnet ef migrations add Your_Migration_Name --context VPortalTenantDbContext --output-dir TenantMigrations
````
